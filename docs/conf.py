...
# _version_py = os.path.join(repo, "src", "superintendent", "__init__.py")
# version_ns = {}
# with open(_version_py) as f:
#     exec(f.read(), version_ns)

# The short X.Y version.
release = superintendent.__version__
release_parts = release.split('.')[:2]
version = f"{release_parts[0]}.{release_parts[1]}"
